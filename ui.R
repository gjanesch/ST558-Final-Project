...
fuel_model_info = box(width = 4, title = "Model Info")

fuel_predictor = box(width = 4, title = "Prediction")

primary_fuel_tab = tabItem("model_fuel", fluidRow(fuel_selector, fuel_model_info, fuel_predictor))
####################################################################################################
